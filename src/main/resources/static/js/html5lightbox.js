...
function loadHtml5LightBox(jsFolder) {
    (function ($) {
        $.fn.html5lightbox = function (options) {
            ...
            var ELEM_TYPE = 0, ELEM_HREF = 1, ELEM_TITLE = 2, ELEM_GROUP =
            ...
            for (var i = 0; i < image_list.length; i++)if (inst.options[image_list[i]])if (inst.options[image_list[i]].substring(0,
            ...
            if (inst.options.initsocial) $("head").append('<link rel="stylesheet" href="/css/fontello.css" type="text/css" />');
            inst.showing = false;
            ...
            inst.showNavigation = function () {
                ...
                for (i = 0; i < inst.elemArray.length; i++)if (inst.matchGroup(group, inst.elemArray[i][ELEM_GROUP]))if (inst.elemArray[i][ELEM_THUMBNAIL] && inst.elemArray[i][ELEM_THUMBNAIL].length >
                    0) {
                    showNav = true;
                    break
                }
            ...
            inst.resizeWindow = function () {
                ...
                if (inst.options.responsivebarheight) {
                    ...
                    if (inst.options.titlestyle == "bottom" && inst.options.barautoheight != "auto") inst.$elemData.css({
                        ...
                        "px", "max-height": inst.options.barheight + "px"
                    })
                }
                ...
                if (inst.options.autoresizecontent && (inst.currentElem[ELEM_TYPE] == 7 || inst.currentElem[ELEM_TYPE] == 10)) {
                    ...
                    if (resizeHeight) {
                        sizeObj =
                            inst.calcElemSize({w: elemW, h: elemH}, keepratio);
